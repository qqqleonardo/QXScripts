...
配置 (QuanX)
[MITM]
hostname = dkmall.51pt.top

[rewrite_local]
^https:\/\/dkmall\.51pt\.top\/app\/ys\/mine\/getMemberInfo url script-request-header https://raw.githubusercontent.com/qqqleonardo/scripts/refs/heads/main/DK.js

[task_local]
28 6 * * * https://raw.githubusercontent.com/qqqleonardo/scripts/refs/heads/main/DK.js, tag=杜康会员俱乐部小程序, enabled=true
====================================================================================================
*/
const $ = new Env("杜康会员俱乐部小程序");
const DKHY =
  ($.isNode() ? JSON.parse(process.env.DKHY) : $.getdata("DKHY")) || [];
let notice = "";
!(async () => {
