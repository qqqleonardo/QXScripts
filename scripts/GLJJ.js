...
配置 (QuanX)
[MITM]
hostname = https://member.guoyuejiu.com

[rewrite_local]
^https:\/\/member\.guoyuejiu\.com\/api\/coupon\/list\/recommend url script-request-header https://raw.githubusercontent.com/qqqleonardo/scripts/refs/heads/main/GLJJ.js

[task_local]
15 10 * * * https://raw.githubusercontent.com/qqqleonardo/scripts/refs/heads/main/GLJJ.js, tag=国乐酱酒小程序, enabled=true
====================================================================================================
*/
const $ = new Env("国乐酱酒小程序");
const GLJJ =
  ($.isNode() ? JSON.parse(process.env.GLJJ) : $.getdata("GLJJ")) || [];
let notice = "";
!(async () => {
...
//                 'mac': `mac`,
//                 'version': `mini_1.2.5`,
//                 'x-client-device': `osXo85NGGMymh3bMwvBBlD09x0OI`,
//                 'app_name': `mini_kiddol`,
...
//                 'Authorization': `${token}`,
//                 'Host' : `wecom-frontapi.aptamil.com.cn`,
...
async function commonGet(uri, token) {
  return new Promise((resolve) => {
    const options = {
      url: `https://member.guoyuejiu.com/api${uri}`,
      headers: {
